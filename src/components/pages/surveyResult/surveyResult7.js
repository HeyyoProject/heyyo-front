...
export default function SurveyResult7({ restartSurvey }) {
  return (
    <>
      <div className="container">
        <h2 className="title">
          해요님은{" "}
          <span style={{ fontSize: "50", color: "#E73828" }}>
            &apos;집중&apos;
          </span>{" "}
          타입이시군요!
        </h2>
      ...
      <div className="container">
        <img className="image" src="/img/Survey10.svg" />
        <div className="bg">
          <h1 className="bgContent">#열쩡열쩡열쩡!#한_우물만#초집중</h1>
        </div>
      </div>
