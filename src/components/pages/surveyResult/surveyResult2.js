...
export default function SurveyResult2({ restartSurvey }) {
  return (
    <>
      <div className="container">
        <h2 className="title">
          해요님은{" "}
          <span style={{ fontSize: "50", color: "#BA76D6" }}>
            &apos;소심&apos;
          </span>{" "}
          타입이시군요!
        </h2>
      ...
      <div className="container">
        <img className="image" src="/img/Survey4.svg" />
        <div className="bg">
          <h1 className="bgContent">#소심하지만_적극적#인터넷인싸</h1>
        </div>
      </div>
