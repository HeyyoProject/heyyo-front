...
export default function SurveyResult5({ restartSurvey }) {
  return (
    <>
      <div className="container">
        <h2 className="title">
          해요님은{" "}
          <span style={{ fontSize: "50", color: "#FFB92E" }}>
            &apos;소통&apos;
          </span>{" "}
          타입이시군요!
        </h2>
      ...
      <div className="container">
        <img className="image" src="/img/Survey5.svg" />
        <div className="bg">
          <h1 className="bgContent">#1디저트_3수다#말로공부#대화</h1>
        </div>
      </div>
