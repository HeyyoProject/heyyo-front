...
export default function SurveyResult3({ restartSurvey }) {
  return (
    <>
      <div className="container">
        <h2 className="title">
          해요님은{" "}
          <span style={{ fontSize: "50", color: "#FF4545" }}>
            &apos;유익&apos;
          </span>{" "}
          타입이시군요!
        </h2>
      ...
      <div className="container">
        <img className="image" src="/img/Survey8.svg" />
        <div className="bg">
          <h1 className="bgContent">#최고효율#유익한자료#알쓸신잡</h1>
        </div>
      </div>
